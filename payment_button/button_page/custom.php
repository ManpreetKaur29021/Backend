...
if(isset($_POST['submit'])){
    ...
    // echo $buttonid;
    $id=$_SESSION['userid'];
    $descp= '&lt;script src="http://localhost/new_project/templates/custom_button.js" data-payment_button_id='."$buttonid".'&gt;&lt;/script&gt;';
    mysqli_query($con,"insert into custom_btn(id,cbid,title,button_label,button_theme,amtl,amt,emaill,phonel,namel,addressl,pincodel) values('$id','$buttonid','$title','$button_label','$button_theme','$amt_label','$amt','$email_label','$phone_label','$name_label','$address_label','$pincode_label')");
    ...
    <nav class="navbar">
        ...
        <div class="box">
                    ...
                    <div style="margin-left: 20px;">
                            <div class="form-group row">
                                ...
                                <select name="b-type" class="form-control input-sm" onchange="location = this.value;">
                                        ...
                                        <option value="custom.php" selected>Custom Button</option>   
                                     </select> 
                               </div>
          ...
          <div class="left form2">
            ...
            <h2 style="margin-bottom: 4rem;">Amount Details</h2>
            <div class="button-div">
                <div style="margin-left: 20px;">
                        <div class="form-group row">
                            <label class="col col-md-1"style="margin-left: 44px;"><b>Label</b></label>
                            <div class="col-md-3">
                                <input class="form-control input-sm" name="amtl" id="amount-label" value="Amount">
                            </div>                                
                            <label class="col col-md-1"><b>Amount</b></label>
                            <div class="col-md-3">
                                <input class="form-control input-sm" name="amt" id="amt-value" value="1">
                            </div>
            ...
            <div class="button-div">
                <div style="margin-left: 20px;">
                        <div class="form-group row">
                            ...
                            <label class="col col-md-1"><b>label</b></label>
                            <div class="col-md-3">
                                <input class="form-control input-sm" name="phone-label" value="Phone" id="phone-label">
                            </div>
                            ...
                            <label class="col col-md-1"><b>label</b></label>
                            <div class="col-md-3">
                                <input class="form-control input-sm" name="name-label" value="Name" id="name-label">
                            </div>
        ...
        <div class="box">
           ...
           <div class="center cform2" id="create_form"  >   
           <div>
            <div class="form_header">
                <h6>Customer Details</h6>
                <p><?php echo $_SESSION['ADMIN_USER']  ?></p>
        ...
        <div class="form_body" style="background-color:#f1eeee ">
          ...
          <div class="right cform3" id="create_form" style=" background-color: none; width:30%; margin-top: -547px; margin-left:1000px; background-color:#e6e6e6;"> 
