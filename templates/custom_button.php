<?php
    ...
    $q = "select * from custom_btn where cbid='$cbid'";
    ...
    if(isset($_POST['submit'])){
        ...
        mysqli_query($con,"insert into button_transaction(id,payid,name,email,phone,address,pincode,amt,createe,status,buttonid) values('$id','$payid','$name','$email','$phone','$address','$pincode','$amt','$time','$status','$cbid')");
        ...
        $sql = "UPDATE button SET usold = usold+1,tsales = tsales+$amt WHERE buttonid = '$cbid'";
...
<form method="post">
    <div id="#button">
        ...
        <button type="button" class="button dark" id="final_button" >
    ...
    <div class="form" id="#form" style="display: none;width: 473px;">
         ...
         <div class="form_body">
                <div>
                    <input type="text" style="  margin-top: 51px;  margin-left: 18px;" class="detail" name="" value="<?php echo $amt_label?>"  disabled id="amount-output" >
                    <input class="input" style="  margin-top: 18px;margin-left: 18px;background:white;" placeholder="&#8377; 0.00" id="amt-label"value="&#8377; <?php echo $amt?>" disabled  > 
                </div>                     
            </div>
...
<div id="#form1"  style=" display:none;">
    <div class="right form" id="create_form " style="width: 473px;"> 
