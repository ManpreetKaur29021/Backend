<?php
    ...
    $q = "select * from quick_pay where buttonid='$btnid'";
    ...
    if(isset($_POST['submit'])){
        ...
        mysqli_query($con,"insert into button_transaction(id,payid,name,email,phone,address,pincode,amt,createe,status,buttonid) values('$id','$payid','$name','$email','$phone','$address','$pincode','$amt','$time','$status','$btnid')");
        ...
        $sql = "UPDATE button SET usold = usold+1,tsales = tsales+$amt WHERE buttonid = '$btnid'";
...
<head>
    ...
    <link href="./css/quick_pay.css" rel="stylesheet">
...
<form  method="post">
    ...
    <button class="button dark paybutton1" type="button" id="final_button" >
    <input class="dark-input" type="text" id="myInput3" style="font-weight: bold;" value="<?php echo $buttonlabel?>" disabled></input>
    <div class="secure">Secure By B-pay</div>
</button>
    </div>
    </div>
    
   <div class="form invisible" id="#form" style=" width:472px">
    <div class="right nform2">
        <!-- <form method="post"> -->
            ...
            <div class="form_body">
                <div>
                    <input type="text"style="  margin-top: 13px;margin-left:18px" class="detail" value="<?php echo $email_label?>" name="" id="email-output" disabled>
                    <input class="input"  style="margin-left:18px" name="uemail"> 
                </div> 
                <input type="text" style="  margin-top: 6px;margin-left:18px" name=""class="detail" value="<?php echo $phone_label?>"  disabled id="phone-output">
                <input class="input" style="margin-left:18px" name="uphone"> 

                <input type="text" style="  margin-top: 6px;margin-left:18px" name="" class="detail" value="<?php echo $name_label?>" disabled id="name-output">
                <input class="input" style="margin-left:18px" name="uname">

                <input type="text" name="" style="  margin-top: 6px;margin-left:18px" class="detail" value="<?php echo $address_label?>" disabled id="adress-output">
                <input class="input" style="margin-left:18px" name="uaddress">
                
                <input type="text" name="" style="  margin-top: 6px;margin-left:18px"class="detail" disabled value="<?php echo $pincode_label?>" id="pincode-output">
                <input class="input" style="margin-left:18px" name="upincode">
                
            </div>

            <button type="button"class="navbar-button" id="pay">
                <div style="display: grid;margin-left: 17px;margin-left: 194px;">
                    <span>Pay</span>
                </div>
            </button>
...
<!-- Payment modes -->
<div class="container py-5 fifth invisible" style="width: 556px; left:523px;">
        <!-- For demo purpose -->
